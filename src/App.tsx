...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// CHECK WICH BUTTON HAVE BEEN PRESSED
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  const buttonPress = (symbol: string) => {
    if (symbol === "clear") {
      ...
      // split by operatrs and get last number
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  const calculate = () => {
    ...
    // clean the expression so that two operators in a roww uses the last operator
    // 5 * - + 5 = 10
    const parts = et.split(" ");
    const newParts = [];

    // go through parts backwrds
